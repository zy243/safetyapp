...
const userSchema = new Schema({
    ...
    privacySettings: {
        ...
        autoFlashlightOnSOS: { type: Boolean, default: true },
        smartGuardianAlerts: { type: Boolean, default: true }
    },
...
userSchema.virtual('isOnline').get(function () {
    return this.lastActivity && (Date.now() - this.lastActivity.getTime()) < 15 * 60 * 1000;
});
