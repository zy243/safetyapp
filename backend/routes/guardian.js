...
router.post('/update-location', updateGuardianLocation);
router.post('/complete', completeGuardianSession);
router.get('/active', getActiveGuardianSession);
router.get('/history', getGuardianHistory);
